...
void main() {
  ...
  test('Space evenly', () {
    final box1 = RenderConstrainedBox(additionalConstraints: const BoxConstraints.tightFor(width: 100.0, height: 100.0));
    final box2 = RenderConstrainedBox(additionalConstraints: const BoxConstraints.tightFor(width: 100.0, height: 100.0));
    final box3 = RenderConstrainedBox(additionalConstraints: const BoxConstraints.tightFor(width: 100.0, height: 100.0));
    final flex = RenderFlex(textDirection: TextDirection.ltr, mainAxisAlignment: MainAxisAlignment.spaceEvenly);
  ...
  test('Fit.loose', () {
    ...
    final box2 = RenderConstrainedBox(additionalConstraints: const BoxConstraints.tightFor(width: 100.0, height: 100.0));
    final box3 = RenderConstrainedBox(additionalConstraints: const BoxConstraints.tightFor(width: 100.0, height: 100.0));
    final flex = RenderFlex(textDirection: TextDirection.ltr, mainAxisAlignment: MainAxisAlignment.spaceBetween);
    flex.addAll(<RenderBox>[box1, box2, box3]);
    layout(flex, constraints: const BoxConstraints(
      maxWidth: 500.0,
      maxHeight: 400.0,
  ...
  test('Flex RTL', () {
    ...
    final box2 = RenderConstrainedBox(additionalConstraints: square);
    final box3 = RenderConstrainedBox(additionalConstraints: square);
    final flex = RenderFlex(textDirection: TextDirection.ltr, children: <RenderBox>[box1, box2, box3]);
    layout(flex);
  ...
  group('Intrinsics', () {
    test('main axis intrinsics with RenderAspectRatio 1', () {
      ...
      final box1 = RenderConstrainedBox(additionalConstraints: square);
      final box2 = RenderConstrainedBox(additionalConstraints: square);
      final box3 = RenderAspectRatio(aspectRatio: 1.0, child: RenderConstrainedBox(additionalConstraints: square));
      final flex = RenderFlex(
        textDirection: TextDirection.ltr,
      );
      flex.addAll(<RenderBox>[box1, box2, box3]);
    ...
    test('cross axis intrinsics, with ascending flex flow layout', () {
      ...
      final textSpan = TextSpan(text: List<String>.filled(3, 'A').join('\u200B') , style: const TextStyle(fontSize: 10));
      final box1 = RenderConstrainedBox(additionalConstraints: square);
