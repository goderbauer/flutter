...
void main() {
  ...
  test('assembleSemanticsNode handles empty WidgetSpans that do not yield selection boxes', () {
    final text = TextSpan(text: '', children: <InlineSpan>[
      TextSpan(text: 'A', recognizer: TapGestureRecognizer()..onTap = () {}),
  ...
  test('TextSpan Hit testing with text justification', () {
    ...
    final textSpanC = TextSpan(text: 'C' * 10);  // The third span starts a new line since it's too long for the first line.
    ...
    final paragraph = RenderParagraph(text, textDirection: TextDirection.ltr, textAlign: TextAlign.justify);
    layout(paragraph, constraints: const BoxConstraints.tightFor(width: 100.0));
    BoxHitTestResult result;
...
// Regression test for https://github.com/flutter/flutter/issues/126652.
    ...
    test('getPositionForOffset works', () async {
      final paragraph = RenderParagraph(const TextSpan(text: '1234567'), textDirection: TextDirection.ltr);
      layout(paragraph);
