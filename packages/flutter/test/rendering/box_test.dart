...
void main() {
  ...
  test('reparenting should clear position', () {
    final coloredBox = RenderDecoratedBox(
      decoration: const BoxDecoration(),
    );
  ...
  group('ConstraintsTransformBox', () {
    ...
    test('throws if the resulting constraints are not normalized', () {
      final child = RenderConstrainedBox(additionalConstraints: const BoxConstraints.tightFor(height: 0));
  ...
  group('hit testing', () {
    ...
    test('localToGlobal with ancestor', () {
      final innerConstrained = RenderConstrainedBox(additionalConstraints: const BoxConstraints.tightFor(width: 50, height: 50));
      final innerCenter = RenderPositionedBox(child: innerConstrained);
      final outerConstrained = RenderConstrainedBox(additionalConstraints: const BoxConstraints.tightFor(width: 100, height: 100), child: innerCenter);
