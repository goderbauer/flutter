...
void main() {
  group(LogicalKeySet, () {
    ...
    test('LogicalKeySet.hashCode is stable', () {
      ...
      final set3 = LogicalKeySet(LogicalKeyboardKey.keyA, LogicalKeyboardKey.keyB, LogicalKeyboardKey.keyC);
      expect(set3.hashCode, set3.hashCode);

      final set4 = LogicalKeySet(LogicalKeyboardKey.keyA, LogicalKeyboardKey.keyB, LogicalKeyboardKey.keyC, LogicalKeyboardKey.keyD);
  ...
  group(SingleActivator, () {
    ...
    testWidgets('isActivatedBy works as expected', (WidgetTester tester) async {
      ...
      const noRepeatSingleActivator = SingleActivator(LogicalKeyboardKey.keyA, control: true, includeRepeats: false);
    ...
    testWidgets('numLock works as expected when set to LockState.locked', (WidgetTester tester) async {
      ...
      const singleActivator = SingleActivator(LogicalKeyboardKey.numpad4, numLock: LockState.locked);
    ...
    testWidgets('numLock works as expected when set to LockState.unlocked', (WidgetTester tester) async {
      ...
      const singleActivator = SingleActivator(LogicalKeyboardKey.numpad4, numLock: LockState.unlocked);
