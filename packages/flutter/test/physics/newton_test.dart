...
void main() {
  ...
  test('test_friction_through', () {
    ...
    // value for _drag.
    var friction = FrictionSimulation.through(startPosition, endPosition, startVelocity, endVelocity);
    expect(friction.isDone(0.0), false);
  ...
  test('spring_types', () {
    var crit = SpringSimulation(SpringDescription.withDampingRatio(
      mass: 1.0,
      stiffness: 100.0,
    ), 0.0, 300.0, 0.0);
    ...
    final under = SpringSimulation(SpringDescription.withDampingRatio(
      mass: 1.0,
      stiffness: 100.0,
      ratio: 0.75,
    ), 0.0, 300.0, 0.0);
    ...
    final over = SpringSimulation(SpringDescription.withDampingRatio(
      mass: 1.0,
      stiffness: 100.0,
      ratio: 1.25,
    ), 0.0, 300.0, 0.0);
    ...
    final other = SpringSimulation(const SpringDescription(
      mass: 1.0,
      stiffness: 100.0,
      damping: 20.0,
    ), 0.0, 20.0, 20.0);
  ...
  test('crit_spring', () {
    final crit = SpringSimulation(SpringDescription.withDampingRatio(
      mass: 1.0,
      stiffness: 100.0,
    ), 0.0, 500.0, 0.0);
