...
void main() {
  ...
  test('File image sets tag', () async {
    ...
    final completer = provider.loadBuffer(provider, noOpDecoderBufferCallback) as MultiFrameImageStreamCompleter;
  ...
  test('Asset image sets tag', () async {
    ...
    final completer = provider.loadBuffer(key, noOpDecoderBufferCallback) as MultiFrameImageStreamCompleter;
