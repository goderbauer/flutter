...
void main() {
  ...
  test('ColorSwatch test', () {
    ...
    final greens1 = ColorSwatch<String>(
      color,
      const <String, Color>{
    ...
    final greens2 = ColorSwatch<String>(
      color,
      const <String, Color>{
        '2259 C': Color(0xFF027223),
        '2273 C': Color(0xFF257226),
  ...
  test('ColorDiagnosticsProperty includes valueProperties in JSON', () {
    ...
    final valueProperties = property.toJsonMap(const DiagnosticsSerializationDelegate())['valueProperties']! as Map<String, Object>;
