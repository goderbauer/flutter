...
void main() {
  ...
  testWidgets('Tooltip margin - ThemeData', (WidgetTester tester) async {
    ...
    final tip = tester.renderObject(find.text(tooltipText)).parent!.parent!.parent!.parent!.parent! as RenderBox;
  ...
  testWidgets('Material2 - Tooltip decoration - ThemeData.tooltipTheme', (WidgetTester tester) async {
    ...
    final tip = tester.renderObject(find.text(tooltipText)).parent!.parent!.parent!.parent! as RenderBox;
