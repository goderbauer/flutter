...
void main() {
  ...
  testWidgets('Multiline hint text will wrap up to maxLines', (WidgetTester tester) async {
    ...
    const multipleLineText = "Here's a text, which is more than one line, to demonstrate the multiple line hint text";
  ...
  group('Triple tap/click', () {
    const testValueA = 'Now is the time for\n' // 20
        'all good people\n'                         // 20 + 16 => 36
        'to come to the aid\n'                      // 36 + 19 => 55
        'of their country.';                        // 55 + 17 => 72
    const testValueB = 'Today is the time for\n' // 22
        'all good people\n'                         // 22 + 16 => 38
        'to come to the aid\n'                      // 38 + 19 => 57
  ...
  testWidgets('Text selection menu hides after select all on desktop', (WidgetTester tester) async {
    ...
    final selectAll = defaultTargetPlatform == TargetPlatform.macOS
        ? 'Select All'
        : 'Select all';
