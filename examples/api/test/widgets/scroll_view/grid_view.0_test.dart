...
void main() {
  testWidgets('$CustomGridLayout', (WidgetTester tester) async {
    ...
    final minOffsets = List<int>.generate(10, (int i) => layout.getMinChildIndexForScrollOffset(i * 80.0));
    expect(minOffsets, <int>[0, 0, 2, 4, 5, 7, 7, 9, 10, 12]);
    final maxOffsets = List<int>.generate(10, (int i) => layout.getMaxChildIndexForScrollOffset(i * 80.0));
    expect(maxOffsets, <double>[1, 1, 3, 4, 6, 8, 8, 9, 11, 13]);
    final offsets = List<SliverGridGeometry>.generate(20, (int i) => layout.getGeometryForChildIndex(i));
