...
void main() {
  testWidgets('$CustomNetworkImage', (WidgetTester tester) async {
    const expectedUrl = 'https://flutter.github.io/assets-for-api-docs/assets/widgets/flamingos.jpg?dpr=3.0&locale=en-US&platform=android&width=800.0&height=600.0&bidi=ltr';
    final log = <String>[];
